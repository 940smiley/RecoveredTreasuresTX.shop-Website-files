...
const mockProducts = [
  {
    ...
    description: 'Original 1977 Topps Star Wars trading card featuring Luke Skywalker. Near mint condition.',
    price: 45.00,
    originalPrice: 60.00,
    condition: 'Near Mint',
  ...
  },
  {
    ...
    description: 'Rare first edition of Tarzan of the Apes by Edgar Rice Burroughs, published in 1914.',
    price: 1200.00,
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Original Pokemon Base Set Charizard holographic card in excellent condition.',
    price: 350.00,
    condition: 'Excellent',
  ...
  },
  {
    ...
    description: 'Vintage Coca-Cola mini refrigerator, holds 2 cans. Working condition.',
    price: 85.00,
    condition: 'Very Good',
...
function ProductCard({ product }: { product: typeof mockProducts[0] }) {
  const getRarityColor = (rarity: string) => {
    switch (rarity.toLowerCase()) {
      case 'extremely rare': return 'bg-red-100 text-red-800'
      case 'very rare': return 'bg-orange-100 text-orange-800'
